...
import 'package:testapp/view/myrecipes/my_recipes_list.dart';
import 'package:testapp/view/recipes/recipe_list.dart';
import 'package:testapp/view/shopping/shopping_list.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  void initState() {
    super.initState();
    pageList
      ..add(const RecipeList())
      ..add(const MyRecipesList())
      ..add(const ShoppingList());
